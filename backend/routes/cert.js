...
router.get('/:userName/:college', async (req, res) => {
    try {
        ...
        pdfDoc.font('Helvetica-Bold').fontSize(25).fillColor('black').text(userName, 100, 295.50, { align: 'center' });
        pdfDoc.font('Helvetica-Bold').fontSize(25).fillColor('black').text(college, 110, 340, { align: 'center' });
